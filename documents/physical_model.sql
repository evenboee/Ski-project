...
DROP DATABASE IF EXISTS db_project5276;
CREATE DATABASE db_project5276
...
ALTER TABLE `shipment`
  ...
  ADD CONSTRAINT `shipment_Customer_representative_fk` FOREIGN KEY (`repNo`) REFERENCES `employee` (`number`) ON UPDATE CASCADE,
                                                                                                                                                                                                                                             ADD CONSTRAINT `shipment_Order_fk` FOREIGN KEY (`order_number`) REFERENCES `ski_order` (`order_number`) ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE `ski_order`
  ...
  ADD CONSTRAINT `ski_order_shipment_fk` FOREIGN KEY (`shipment_number`) REFERENCES `shipment` (`number`) ON UPDATE CASCADE ON DELETE CASCADE;
